...
class TD3Agent4(Agent):
    ...
    def train(self, states, actions, next_states, rewards, dones, current_step):
        ...
        with torch.no_grad():
            ...
            next_q_values_target = self.target_critic(next_states, next_actions)
...
if __name__ == "__main__":
    ...
    for i in range(5):
        ...
        agent = TD3Agent4(n, m, dim, actor_H, critic_H, action_max, action_min, alpha, gamma, sigma, tau, sigma_target, c, d)
